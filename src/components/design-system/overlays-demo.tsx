        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            <div key={title} className="flex flex-col gap-1">
              <span className="font-sans text-ds-body font-medium text-ds-neutral-1000 dark:text-ds-neutral-0">{title}</span>
              <span className="font-sans text-ds-body font-medium text-ds-neutral-500">{time}</span>
            </div>
          ))}
        </div>
      </Drawer>
