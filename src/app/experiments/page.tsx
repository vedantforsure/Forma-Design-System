...
function ComponentRow({ label, children, id, footnote }: { label: string; children: React.ReactNode; id?: string; footnote?: React.ReactNode }) {
  return (
    <div id={id} className="flex flex-col sm:flex-row sm:items-center items-start gap-2 sm:gap-12 scroll-mt-8">
      <div className="sm:w-40 sm:shrink-0 flex flex-col gap-1">
